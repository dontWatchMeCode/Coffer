...
#[Name('records.create')]
#[Description('Create a task, calendar event, contact, bookmark, note, collection, log entry, or file in the current team. File records may include base64-encoded content.')]
