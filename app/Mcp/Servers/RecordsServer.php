...
#[Name('Records Server')]
#[Version('1.0.0')]
#[Instructions('CRUD current-team tasks, calendar events, contacts, bookmarks, notes, collections, log entries, and files (with optional base64 content upload). Supports generic linked records and tags.')]
